...
Get the configuration object 'letheanSDPConfiguration'.
...
#>
function Get-letheanSDPConfiguration {
...
System.Collections.Hashtable
#>
function Set-letheanSDPConfiguration {
...
None
#>
function Set-letheanSDPConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-letheanSDPConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-letheanSDPConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
System.Collections.Hashtable[]
#>
function Get-letheanSDPHostSetting {
    return ,@(
          @{
            "Url" = "";
...
String
#>
function Get-letheanSDPUrlFromHostSetting {
    ...
    Process {
        $Hosts = Get-letheanSDPHostSetting
...
System.Collections.Hashtable
#>
function Set-letheanSDPConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-letheanSDPKeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'letheanSDPConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-letheanSDPConfigurationHttpSigning{
